    ...
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string userId, List<string> roles)
        {
            ...
            if (user != null)
            {
                ...
                /*if (!((user.UserName != "mivladi99@yandex.ru" && User.Identity.Name == "mivladi99@yandex.ru") || !(await _userManager.IsInRoleAsync(user, "admin"))))
                {
                    if (addedRoles.Contains("admin") && User.Identity.Name == "mivladi99@yandex.ru")
                    {
                ...
                if(User.Identity.Name != "mivladi99@yandex.ru")
                {
                    if (user.UserName == "mivladi99@yandex.ru")
                    {
                ...
                else if(user.UserName == "mivladi99@yandex.ru" && removedRoles.Contains("admin"))
                {
